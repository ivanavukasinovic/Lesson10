...
class PalindromeTest {
	...
	void testWordExists() throws Exception {
		assertTrue(testPalindrome.wordExists("banana"));
		assertFalse(testPalindrome.wordExists("bananana"));
	}
	...
	void testIsPalindrome() throws Exception {
		...
		assertFalse(testPalindrome.isPalindrome("aaaaaa"));
		assertFalse(testPalindrome.isPalindrome("Aaron"));
	}
